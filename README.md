...
This repository contains my progress in advanced Java Programming and competitive coding.
Current Projects

* Genetic Algorithm : A program that uses evolutionary principles (selection,crossover,Mutation) .

  
Currently I am on step 1:  Creating initial population.
[GeneticAlgorithm.java](https://github.com/user-attachments/files/26528735/GeneticAlgorithm.java)
